...
public class CrowdConstant {
	...
	public static final String MESSAGE_CODE_NOT_EXISTS = "验证码过期,请输入正确的手机号或重新发送验证码";
	...
	public static final String ATTR_NANE_MESSAGE = "message";
	public static final String ATTR_NAME_TEMPLE_PROJECT = "tempProject";
	
	public static final String MESSAGE_ACCESS_DENIED = "抱歉，您没有权限访问资源";
	public static final String REDIS_CODE_PREFIX = "REDIS_CODE_PREFIX_";
    public static final String ATTR_NAME_MESSAGE = "session_message";
