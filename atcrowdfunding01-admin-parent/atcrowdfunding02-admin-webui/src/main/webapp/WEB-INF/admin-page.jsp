...
<script type="text/javascript">
	...
	function pageSelectCallback(pageIndex, jQuery) {
		...
		if (pageIndex == ${requestScope.pageInfo.pageNum - 1}){
			return false;
		}
								...
								<tfoot>
									<tr>
										<td colspan="6" align="center">
											...
											<%--利用pageInfo.navigatepageNums 进行的分页,效果不如 paination--%>
											<%--<td colspan="6" align="center">
												<div>
													<a href="admin/get/page.html?pageNum=1&keyword=${param.keyword}">首页</a>
													<a href="admin/get/page.html?pageNum=${pageInfo.pageNum-1}&keyword=${param.keyword}">上一页</a>
													<c:forEach items="${pageInfo.navigatepageNums}" var="page">
														<c:if test="${pageInfo.pageNum == page}">
															【${page}】
														</c:if>
														<c:if test="${pageInfo.pageNum != page}">
															<a href="admin/get/page.html?pageNum=${pageInfo.pageNum}&keyword=${param.keyword}"> ${page} </a>
														</c:if>
													</c:forEach>
													<a href="admin/get/page.html?pageNum=${pageInfo.pageNum+1}&keyword=${param.keyword}">下一页</a>
													<a href="admin/get/page.html?pageNum=100000&keyword=${param.keyword}">末页</a>
												</div>
											</td>--%>
								</tfoot>
							</table>
